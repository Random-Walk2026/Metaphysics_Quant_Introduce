# MetaphysicsQuant - 工程化中国术数分析平台（简体中文）
...
| 易经六爻 | 时间起卦、三数起卦、玄数起卦、本卦变卦、动爻、六亲、六神、世应、纳甲、六十四卦资料。 |
...
| 神数系统 | 铁板神数、邵子神数、太素/太玄类数字推演，支持条文检索、原局、大运、流年和综合分析。 |
...
`esoteric_numerology/` 提供铁板神数、邵子神数和太素/太玄类数字推演。它与西文数理不同，更偏向传统术数中的生辰、干支、刻分、卦象、声音和条文检索。邵子神数支持原局、大运、流年和综合报告；铁板神数支持刻分、考刻和条文输出。
...
| 数理神数 | `esoteric_numerology/README.md` | 铁板神数、邵子神数、太素/太玄数字推演。 | `铁板神数` / `邵子神数` |
